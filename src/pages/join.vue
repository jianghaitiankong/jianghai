<template>
  <div class="join-container">
    ...
    <p>南通江海天空科技创新服务集团有限公司（下简称“江海天空”），UVC控股旗下拟独立IPO平台，是致力于科技双创 与创投基金管理服务，并提供多维创业咨询、独立财经媒体、创新策略咨询、线上线下招商、创业创投服务、项目全 程孵化的综合性科技创新服务集团。业务涵盖天使/VC投资、科技地产、基金三方服务、园区招商、商会咨询、江海学 院等业务。通过北京、上海、深圳、南通、香港、温哥华和硅谷七个自有物理空间，实现项目孵化、招商引资和创投基 金三位一体的业务模式，赋予江海天空多元盈利能力。</p>
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      this.$request
        .post("join/selectAllJoin", data, that.token)
        .then(res => {
...
.recruit .joinText p {
  animation: info 0.5s linear 0s 1 forwards;
  -webkit-animation: info 0.5s linear 0s 1 forwards;
}
